# `@houston/agentic-intelligence-contracts`

Provider-neutral v0.1 contracts for the Agentic Data Intelligence Layer (ADIL).
...
} from "@houston/agentic-intelligence-contracts";
```
...
```bash
pnpm --filter @houston/agentic-intelligence-contracts build
pnpm --filter @houston/agentic-intelligence-contracts typecheck
pnpm --filter @houston/agentic-intelligence-contracts test
pnpm validate
```
