      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-t border-foreground/10 p-3">
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={resolved}
            onClick={onReject}
            className="inline-flex h-9 items-center gap-1.5 border border-foreground/16 px-3 text-xs font-medium text-foreground transition hover:bg-foreground/[0.05] disabled:cursor-not-allowed disabled:opacity-40"
          >
          ...
          <button
            ...
            disabled={resolved}
            onClick={onApprove}
            className="inline-flex h-9 items-center gap-1.5 bg-foreground px-3 text-xs font-medium text-background transition hover:opacity-88 disabled:cursor-not-allowed disabled:opacity-40"
          >
